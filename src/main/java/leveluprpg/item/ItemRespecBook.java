...
public final class ItemRespecBook extends Item {
    public ItemRespecBook() {
        super();
        setRegistryName(LevelUp.ID, "respec_book");
    ...
    public ActionResult<ItemStack> onItemRightClick(World world, EntityPlayer player, EnumHand hand)
    {
        ...
        if (!world.isRemote) {
            PlayerExtendedProperties.getClassOfPlayer(player).refundSkillPoints(itemstack.getItemDamage() > 0, player);
